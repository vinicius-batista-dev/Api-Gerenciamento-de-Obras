...
module.exports = (app) => {
    ...
    app.get('/api/construcao/:id', [jwtAuth.verifyToken], construcaoController.findOne);
    app.put('/api/construcao/atualizar/:id', [jwtAuth.verifyToken], construcaoController.update);
    app.delete('/api/construcao/deletar/:id', [jwtAuth.verifyToken], construcaoController.delete);
}