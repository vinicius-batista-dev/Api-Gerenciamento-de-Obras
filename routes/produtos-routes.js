...
module.exports = (app) => {
    ...
    app.put('/api/produtos/atualizar/:id', [jwtAuth.verifyToken], produtosController.update);
    app.delete('/api/produtos/deletar/:id', [jwtAuth.verifyToken], produtosController.delete);
}